...
<?php
	...
	$articleFile = basename(__file__); // This will eventually be the index this article takes in the array of all articles.
	$pageTitle = "Simple is Fashionable";
	$heroImage = "read1.jpg";//image_stopper
	$photoCredit = "@PersonOnInstagram";
	$articleTitle = "Simple is Beautiful: Notes on Style & Elegance";//title_stopper
